...
# Set your Google API Key and OpenAI API Key directly in the code
GOOGLE_API_KEY = "AIzaSyC8-OLPwz5M_GDhdQlV2QVdOveFQ8m-oag"
...
def load_data():
    with st.spinner(text="Loading and indexing the documents..."):
        reader = SimpleDirectoryReader(input_dir="https://github.com/HninLwin-byte/Concrete_Chatbot_Test/blob/master/Sustainable_Concrete_Technology.pdf")
        docs = reader.load_data()
