...
# Display logo and header in the first column
with col1:
    st.image('scg_logo.jpg', width=120)
    st.header(":violet[SCG & KMUTT Chat]Bot", divider='rainbow', help="This bot is designed by Ujjwal Deep to address all of your questions hehe")
...
# Function to handle chat input and generate responses
def handle_chat():
    if prompt := st.chat_input("Your question"):
        ...
        with st.chat_message("assistant"):
            with st.spinner("Thinking..."):
                ...
                response = "This is a simulated response based on the input: {}".format(prompt)
                st.write(response)
